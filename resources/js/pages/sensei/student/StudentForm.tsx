...
export default function StudentForm({ student, provinces, jobSectors, majors }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        if (isEdit) {
            // Rute otomatis: sensei.students.update
            put(route('sensei.students.update', student.id), {
                preserveScroll: true,
            });
        } else {
            // Rute otomatis: sensei.students.store
            post(route('sensei.students.store'), {
                preserveScroll: true,
                onError: (errors) => {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Data Siswa', href: '/sensei/students' }, { title: isEdit ? 'Edit' : 'Tambah', href: '#' }]}>
                                ...
                                <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                        ...
                                        <Input
                                            ...
                                            placeholder={isEdit ? undefined : "email@contoh.com"}
                                        />
                                        </FormItem>
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <CardDescription className="text-[10px] sm:text-xs">Wajib tambahkan minimal 1 riwayat pendidikan terakhir.</CardDescription>
                                                </div>
                                            </div>
                                            <Button 
                                                type="button" 
                                    ...
                                    <CardHeader className="px-4 sm:px-6 py-4 sm:py-5 border-b bg-transparent">
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                ...
                                                <div>
                                                    <CardTitle className="text-base sm:text-lg font-bold tracking-tight">Riwayat Pekerjaan <span className="text-red-500">*</span></CardTitle>
                                                    <CardDescription className="text-[10px] sm:text-xs">Wajib tambahkan minimal 1 pengalaman kerja.</CardDescription>
                                                </div>
                                            </div>
                                            <Button 
                                                type="button" 
                                    ...
                                    <CardContent className="p-0">
                                        {data.experiences.length > 0 ? (
                                            ...
                                            <div className="flex flex-col items-center justify-center py-12 sm:py-20 bg-muted/5 px-4">
                                                ...
                                                <p className="text-[10px] sm:text-xs text-red-500 font-bold mt-1 text-center">* Wajib tambahkan minimal 1 data pekerjaan</p>
                                                <Button variant="link" onClick={addExperience} className="mt-2 sm:mt-1 text-blue-600 text-xs sm:text-sm">Tambah data sekarang</Button>
                                            </div>
                                        )}
                                    </CardContent>
                                </Card>
                                    ...
                                    <CardHeader className="px-4 sm:px-6 py-4 sm:py-5 border-b bg-transparent">
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div>
                                                ...
                                                <CardDescription className="text-[10px] sm:text-xs">Data internal ini dikunci dan hanya dapat diubah oleh sensei.</CardDescription>
                                            </div>
                                        </div>
                                    </CardHeader>
