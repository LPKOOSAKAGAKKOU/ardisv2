...
import { Plus, Search, Trash2, Edit, Calendar, ClipboardList, CheckCircle2 } from 'lucide-react';
                                        ...
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex justify-end gap-1">
                                                    <Button variant="ghost" size="icon" className="h-8 w-8 text-blue-600" onClick={() => openModal(item)}>
                                                        <Edit size={14} />
                                                    </Button>
                                                    <Button variant="ghost" size="icon" className="h-8 w-8 text-rose-600" onClick={() => handleDelete(item.id, item.name)}>
                                                        <Trash2 size={14} />
                                                    </Button>
                                                </div>
                                            </TableCell>
