                                        ...
                                        <div className="overflow-hidden rounded-xl">
                                            ...
                                            {msg.message_type === 'image' && msg.media_url && (
                                                <div className="relative group">
                                                    <img 
                                                        // PERBAIKAN: Pastikan URL diawali http untuk mencegah path relatif
                                            ...
                                            {msg.message_type === 'document' && msg.media_url && (
                                                <a 
                                                    ...
                                                    target="_blank" 
                                                    rel="noreferrer" 
                                                    className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-zinc-800 rounded-lg m-1 border border-dashed border-slate-300 hover:bg-slate-100 transition"
                                                >
