    ...
    return (
        ...
        >
            ...
            <button 
                ...
                className={`fixed z-[60] flex items-center justify-center bg-[#25D366] text-white shadow-lg transition-all duration-300
                    ${isOpen 
                        ? 'lg:right-[380px] lg:top-1/2 lg:-translate-y-1/2 lg:w-5 lg:h-12 lg:rounded-l-lg lg:rounded-r-none bg-slate-300 text-slate-600' 
