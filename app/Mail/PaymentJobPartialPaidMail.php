...
class PaymentJobPartialPaidMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Pembayaran Kelulusan Job Diterima (1 dari 2 Tagihan Lunas)',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.payment_job_partial_paid',
        );
    }
